    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/web/user/start", "/web/ressourceBooking/allBookingsEmployee", "/web/ressourceBooking/createBookingEmployee/**", "/web/ressourceBooking/deleteBookingEmployee/**","/web/deskbookings/mydeskbookings","/web/ressource/allRessourcesEmployee", "/web/rooms/allRoomsEmployee", "/web/roomBooking/allBookingsEmployee","/web/roomBooking/createBookingEmployee/**","/web/roomBooking/deleteBookingEmployee/**").hasAnyRole("N_EMPLOYEE", "P_EMPLOYEE");
                    authConfig.requestMatchers(HttpMethod.GET,"/web/**","/web/**/**","/web/**/**/**").hasAnyRole("ADMIN", "OPERATOR");
                    authConfig.requestMatchers(HttpMethod.POST, "/web/login").permitAll();
                    authConfig.requestMatchers(HttpMethod.POST, "/web/desks/add/**", "/web/ressource/**", "/web/roomBooking/**", "/web/ressourceBooking/**", "/web/rooms/**").hasAnyRole( "N_EMPLOYEE", "P_EMPLOYEE");
                    authConfig.requestMatchers(HttpMethod.POST, "/web/**","/web/rooms/allRooms", "/web/roomBooking/allBookings","/web/roomBooking/createBooking/**","/web/roomBooking/deleteBooking/**","/web/rooms/updateRoom/**","/web/rooms/updateRoom", "/web/ressource/addRessource").hasAnyRole("ADMIN", "OPERATOR");
