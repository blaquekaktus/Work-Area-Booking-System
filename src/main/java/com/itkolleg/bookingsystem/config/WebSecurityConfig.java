    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET,  "/web/employees/start", "/web/ressource/**", "/web/roomBooking/**", "/web/ressourceBooking/**", "/web/floorsEmployee","/web/desks/**","/web/rooms/**").hasAnyRole("OPERATOR", "N_EMPLOYEE", "P_EMPLOYEE");
                    ...
                    authConfig.requestMatchers(HttpMethod.POST, "/web/desks/**", "/web/ressource/**", "/web/roomBooking/**", "/web/ressourceBooking/**", "/web/rooms/**").hasAnyRole("OPERATOR", "N_EMPLOYEE", "P_EMPLOYEE");
