    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/web/deskbookings/mydeskbookings", "/web/deskbookings/view/**", "/web/deskbookings/add","/web/deskbookings/new","/web/deskbookings/update/**","/web/deskbookings/deskbookinghistory/**","/web/deskbookings/cancel/**","/web/user/start", "/web/ressourceBooking/allBookingsEmployee", "/web/ressourceBooking/createBookingEmployee/**", "/web/ressourceBooking/deleteBookingEmployee/**","/web/deskbookings/mydeskbookings","/web/ressource/allRessourcesEmployee", "/web/rooms/allRoomsEmployee", "/web/roomBooking/allBookingsEmployee","/web/roomBooking/createBookingEmployee/**","/web/rooms/floorsEmployee","/web/desks/view/**").hasAnyRole("ADMIN", "OPERATOR", "N_EMPLOYEE", "P_EMPLOYEE");
                    authConfig.requestMatchers(HttpMethod.GET,"/web/**","/web/desks/**").hasAnyRole("ADMIN", "OPERATOR");
                    authConfig.requestMatchers(HttpMethod.POST,  "/web/deskbookings/view/**", "/web/deskbookings/add","/web/deskbookings/new","/web/deskbookings/update","/web/deskbookings/cancel/**","/web/ressource/**", "/web/roomBooking/**", "/web/ressourceBooking/**", "/web/rooms/**","/web/roomBooking/createBookingEmployee/**","/web/roomBooking/updateBooking/**").hasAnyRole( "ADMIN", "OPERATOR","N_EMPLOYEE", "P_EMPLOYEE");
